...
describe('Block',()=>{
    ...
    it('has timestamp,lasthash,hash and data as block properties',()=>{
    ...
    describe("mineBlock()",()=>{
        ...
        it('sets a hash that matches diff criteria',()=>{
            expect(hexTobinary(minedBlock.hash).substring(0,minedBlock.difficulty)).toEqual('0'.repeat(minedBlock.difficulty));
        })
        it('adjust to difficulty',()=>{
    ...
    describe('adjustDifficulty()',()=>{       
        it('races difficultyfor a quickly mined block ',()=>{
